// function gapminder(){
// 	console.log( "Hello from gapminder package");
// }
...
import * as Clusterize from './node_modules/clusterize.js/clusterize.min.js';
 ...
 function testing(){
	console.log("Hello from testing function!");
}
function displayfromGap(){
	console.log("Display from Gap file! ")
}
var dot;
// Top level wrapper function 
 function gapminder(configPath){

console.log("Inside Gapminder ");
console.log("Path provided: ", configPath);
...
function nest(data, array){
 ...
 function displayData(configurationFile){
...
export {gapminder, testing,displayfromGap, displayData };